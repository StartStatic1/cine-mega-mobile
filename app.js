...
// Trava de "Voltar" do Celular
window.addEventListener('popstate', () => { if(document.querySelector('.page.active').id !== 'home') ir('home'); });
...
async function abrir(id, isBreve = false) {
    ...
    if(isBreve) { aviso.style.display = 'block'; btnPlay.style.background = '#333'; btnPlay.innerText = "ESTE FILME AINDA NÃO ESTREOU"; }
    else { aviso.style.display = 'none'; btnPlay.style.background = '#e50914'; btnPlay.innerText = "ASSISTIR AGORA"; }
